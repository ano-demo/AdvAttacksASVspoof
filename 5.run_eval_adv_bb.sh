...
python eval_adv.py    --resume /data/longnv/_saved/models/LA_SENet12_LPSseg_uf_seg600/20221107_161924/checkpoint-epoch5.pt \
					   --adv_data /data/longnv/_saved/models/LA_SENet12_LPSseg_uf_seg600/20221101_110205_NOdistill/pgd_adv_egs_None_5.0 \
...
python eval_adv.py    --resume /data/longnv/_saved/models/LA_SENet12_LPSseg_uf_seg600/20221029_181604/checkpoint-epoch8.pth \
					   --adv_data /data/longnv/_saved/models/LA_SENet12_LPSseg_uf_seg600/20221029_181604/pgd_adv_egs_None_5.0/ \
					   --protocol_file /data/Dataset/ASVspoof/LA/ASVspoof2019_LA_cm_protocols/ASVspoof2019.LA.cm.eval.trl.txt \
                	   --asv_score_file /data/Dataset/ASVspoof/LA/ASVspoof2019_LA_asv_scores/ASVspoof2019.LA.asv.eval.gi.trl.scores.txt  \
	                   --device ${GPU}	
echo done
