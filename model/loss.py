...
class KDloss(nn.Module):
    ...
    def forward(self, y, labels, teacher_scores, T=1, alpha=0.3):
        ...
        return self.loss(F.log_softmax(y[0]/T,dim=1), F.softmax(teacher_scores[0]/T,dim=1)) * (T * T * 2.0 * alpha) + F.cross_entropy(torch.exp(y[0]), labels) * (1. - alpha) # 20221029_1510....
